 ...
 * the {@link Merger}.
 */
final class AtlasvSyncProcessor {
    ...
    /**
     * Returns a step builder to begin construction of a new {@link AtlasvSyncProcessor} instance.
...
//        return Completable.concat(hydrationTasks)
    ...
    /**
     * Builds instances of {@link AtlasvSyncProcessor}s.
     */
    public static final class Builder implements ModelProviderStep, ModelSchemaRegistryStep,
        ...
        @NonNull
        @Override
        public DataStoreConfigurationProviderStep merger(@NonNull AtlasvMerger merger) {
    ...
    interface MergerStep {
        @NonNull
        DataStoreConfigurationProviderStep merger(@NonNull AtlasvMerger merger);
    }
